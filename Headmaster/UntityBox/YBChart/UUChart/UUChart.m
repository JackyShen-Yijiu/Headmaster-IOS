...
-(void)setUpChart{
	if (self.chartStyle == UUChartLineStyle) {
        ...
        if (_xTitleMarkWordString) {
            _lineChart.xTitleMarkWordString = _xTitleMarkWordString;
        }
        if (_yTitleMarkWordString) {
            _lineChart.yTitleMarkWordString = _yTitleMarkWordString;
        }
	...
	}else if (self.chartStyle == UUChartBarStyle)
	{
        ...
        // 显示横纵轴提示
        if (_xTitleMarkWordString) {
            _barChart.xTitleMarkWordString = _xTitleMarkWordString;
        }
        if (_yTitleMarkWordString) {
            _barChart.yTitleMarkWordString = _yTitleMarkWordString;
        }
