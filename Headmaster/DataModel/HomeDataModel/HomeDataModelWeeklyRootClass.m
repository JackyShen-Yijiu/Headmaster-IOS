//
//	HomeDataModelWeeklyRootClass.m
...
@interface HomeDataModelWeeklyRootClass ()
@end
@implementation HomeDataModelWeeklyRootClass
...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary
{
	...
	if(![dictionary[@"data"] isKindOfClass:[NSNull class]]){
		self.data = [[HomeDataModelWeeklyData alloc] initWithDictionary:dictionary[@"data"]];
	}
