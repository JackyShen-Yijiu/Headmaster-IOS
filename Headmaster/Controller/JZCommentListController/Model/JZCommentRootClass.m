...
#import "JZCommentRootClass.h"

@interface JZCommentRootClass ()
@end
@implementation JZCommentRootClass
...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary
{
	...
	if(![dictionary[@"data"] isKindOfClass:[NSNull class]]){
		self.data = [[JZCommentData alloc] initWithDictionary:dictionary[@"data"]];
	}
