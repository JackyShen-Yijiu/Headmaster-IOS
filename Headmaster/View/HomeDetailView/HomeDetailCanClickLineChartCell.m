//
//  HomeDetailCanClickLineChartCell.m
//  Headmaster
//
...
@interface HomeDetailCanClickLineChartCell()

@property (nonatomic, strong) YBLineChartView *lineChartView;

@end

@implementation HomeDetailCanClickLineChartCell
...
- (instancetype)initWithWidth:(CGFloat)width Style:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.lineChartView.frame = CGRectMake(15, self.titleDefaultHeight, width, self.lineChartView.defaultHeight);
    }
    return self;
}
